...
const fontchar_t gBigFontChars_alpha_0_30[NUM_BIG_FONT_CHARS] = {
    {   0, 195,  11,  16 }, // 0 - 0
    {  12, 195,  11,  16 }, // 1 - 1
    {  24, 195,  11,  16 }, // 2 - 2
    {  36, 195,  11,  16 }, // 3 - 3
...
const fontchar_t* I_GetBigFontChars() noexcept {
    ...
    switch (Game::gGameType) {
        case GameType::Doom_Alpha_0_05: return gBigFontChars_alpha_0_05;
        case GameType::Doom_Alpha_0_30: return gBigFontChars_alpha_0_30;
        default: break;
    }
    
    // Typical case (PSX Doom, PSX Final Doom etc.)
    return gBigFontChars;
}
